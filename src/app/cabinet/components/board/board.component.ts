...
export class BoardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private store: Store<fromRoot.State>,
    ...
    this.subscription$.add(route
      ...
      .subscribe((taskId: string) => this.store.dispatch(new TaskActions.OpenAction(taskId))));
  }
  ...
  private _initSortable() {
    jQuery(this.elementRef.nativeElement).sortable({
      ...
      update: () => {
        ...
        const elements = this.elementRef.nativeElement.getElementsByClassName('board__column');
