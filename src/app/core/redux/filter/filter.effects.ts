...
export class FilterEffects {
  ...
  search$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(() => {
        return this.filterService.findAll().pipe(
  ...
  save$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((model: FilterModel) => {
        return this.filterService.save(model).pipe(
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((model: FilterModel) => {
        return this.filterService.create(model).pipe(
  ...
  delete$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((model: FilterModel) => {
        return this.filterService.delete(model).pipe(
